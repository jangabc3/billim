...
const styles = StyleSheet.create({
  ...
  eyebrow: { fontSize: 10.5, fontFamily: fonts.bold, letterSpacing: 1, color: colors.brand },
  title: { fontSize: 20, fontFamily: fonts.bold, lineHeight: 26, color: colors.ink },
  highlight: { color: colors.brand },
  desc: { fontSize: 12.5, fontFamily: fonts.regular, color: colors.ink3, marginTop: 8, lineHeight: 18 },
});